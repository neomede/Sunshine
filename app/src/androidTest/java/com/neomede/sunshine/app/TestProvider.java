...
import com.neomede.sunshine.app.data.WeatherDbHelper;

/**
 * Created by neomede on 17/08/14.
 */
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        long locationRowId;
        Uri insertLocationUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, testValues);
        locationRowId = ContentUris.parseId(insertLocationUri);
